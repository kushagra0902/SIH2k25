...
export default function ValidatorSection() {
  ...
  const handleValidate = async () => {
    ...
    await validateBatch(scannedData.id);
    setIsValidated(true);
    setTimeout(() => {
      setScannedData(null);
      setIsValidated(false);
  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-card">
      <CardHeader className="text-center pb-4">
        <CardTitle className="text-2xl font-bold text-sky-blue flex items-center justify-center gap-2">
          ✅ Validators
        </CardTitle>
      </CardHeader>
          ...
          <div className="space-y-4">
            {isValidated ? (
              <div className="text-center space-y-4">
                ...
                <div className="text-2xl font-bold text-farm-green">VALIDATED!</div>
                <p className="text-lg">
